...
Sprites::Sprites(int nb)
{
    ...
    {
        tileTextures[i].loadFromFile("res/tileset/isometric_pixel_flat_00" + numbers[i] + ".png",
                                     IntRect(0, 0, 34, 24));
...
sf::Sprite Sprites::getContentSprite(int l, int h, int content, int element)
{
    ...
    content -= 2;
    contentSprites[content].setTextureRect(IntRect(offsets[content][0][element], offsets[content][1][element],
                                       ...
                                       int animation)
{
    ...
    characterSprite.setTextureRect(IntRect(animation * 32 + offsetI[id % 12],
                                           direction * 32 + offsetJ[id / 12], 32, 32));
                                    ...
                                    int lv)
{
    ...
    attackSprite.setTextureRect(IntRect(offsetI[lv] + direction * size[lv], offsetJ[lv], size[lv],
                                        size[lv]));
