...
void DisplayState::display() {
    ...
    int N = world->getI(), M = world->getJ(), nb = 3, l = 34 * nb, h = 24 * nb, l2 = 32, h2 = 32;
    RenderWindow window(VideoMode(N * l, M * h), "Jeu");

    Sprite sprite, perso;
    TileSprite neutre("/home/ensea/quellierattigui/res/tileset/isometric_pixel_flat_0000.png", l, h, nb);
    TileSprite eau("/home/ensea/quellierattigui/res/tileset/isometric_pixel_flat_0028.png", l, h, nb);
    TileSprite terre("/home/ensea/quellierattigui/res/tileset/isometric_pixel_flat_0055.png", l, h, nb);
    TileSprite feu("/home/ensea/quellierattigui/res/tileset/isometric_pixel_flat_0037.png", l, h, nb);
    TileSprite air("/home/ensea/quellierattigui/res/tileset/isometric_pixel_flat_0093.png", l, h, nb);
    CharacterSprite persos("/home/ensea/quellierattigui/res/persos.png", l2, h2);
        ...
        for (int j = 0; j < M; j++) {
            for (int i = 0; i < N; i++) {
                ...
                for (auto c = chars.begin(); c != chars.end(); ++c) {
                    ...
                    perso.setPosition(Vector2f(nb * (l - l2) / 2 + l * (*c)->getI(), h * (*c)->getJ()));
                    window.draw(perso);
                }
            }
        }
