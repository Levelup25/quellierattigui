...
\item L'interface utilisateur est gérée par la classe Element qui genère un ensemble de fenêtres potentiellement imbriquables pouvant contenir du texte ou des sprites, permettant alors de créer plusieurs types de fenêtres selon le besoin. Un Element particulier, le WindowManager permet cette gestion.
\end{itemize}
