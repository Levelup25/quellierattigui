...
\item DisplayState réutilise alors les sprites générés pour afficher la carte grâce au RenderWindow de sfml et gère la View correspondante via display().
\end{itemize}
...
\begin{itemize}
    ...
    Comme son nom l'indique celle classe contient l'ensemble des fenêtres, lorsque on souhaite ajouter une fenêtre à la vue de notre jeu il faut l'enregistrer au près du gestionnaire de window. Le gestionnaire s'occupe du déplacement et de la fermeture des fenêtres qu'il contrôle.
    \item UIInventory\\
